        ...
        <div>
            <main className="relative w-full h-screen overflow-hidden text-white">
                ...
                <div className="relative z-10 lg:flex gap-6 h-full container mx-auto pb-[12rem]">
                    <section className="flex flex-col w-full space-y-4 justify-center items-baseline mt-18 space-x-4">
                        <div>
                            ...
                            <div className="text-xl">
                                ...
                                <p className="uppercase  mb-8">
                                    L'endroit rêver pour créer une page de
                                    départ unique : dramatique, drôle, sincère
                                    ou totalement WTF.
                                </p>

                                <p className="uppercase mb-8">
                                    Un dernier mot avant de tourner la page ? Ou
                                    la claquer bruyamment.?
                                </p>
                            </div>
                        ...
                        <div className="mt-8">
                            <div>
                                <Button className="bg-background/2 backdrop-blur-lg uppercase text-2xl p-8 rounded-2xl font-semibold border-[0.5px] border-[#f1caad]/40 text-[#f1caad]">
                                    Créer Ma page
                                </Button>
                            </div>
                        </div>
                    ...
                    <section className="flex flex-col justify-center w-full space-y-6 lg:mt-[14rem]">
